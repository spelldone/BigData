...
<img src="/LR4/images/install.png" width="500"> <br/>
...
<img src="/LR4/images/zkCli.png" width="500"> <br/>
Подключение установлено. Для вывода всех возможных команд наберем ```help```:
<img src="/LR4/images/help.png" width="500"> <br/>
...
<img src="/LR4/images/work.png" width="500"> <br/>
Создадим два нумерованных (sequential) узла в качестве дочерних ```mynode```: <br/>
<br/>
<img src="/LR4/images/create.png" width="500"> <br/>
<br/>
